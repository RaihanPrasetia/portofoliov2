...
const certificates = [
  { id: 1, title: 'Certificate MSIB 6 - Kampus Merdeka', image: Certificate1 },
  { id: 2, title: 'Certificate Peserta - Vetencode', image: Certificate2 },
  ...
  return (
    <section id="certificates" className="section py-16 bg-gray-100">
      <div className="container mx-auto px-4 pt-12 pb-0">
        <h2 className="text-4xl font-bold text-center mb-8 text-white text-cert">Certificates</h2>
          ...
          {certificates.map(certificate => (
            <div key={certificate.id} className="w-full sm:w-1/2 md:w-1/3 px-4 mb-8 ">
              <div className="bg-white rounded-lg shadow-md overflow-hidden h-full bg-gradient-to-r from-blue-700 to-black item">
                <div className="p-4">
                  <h2 className="text-xl font-bold text-center text-white">{certificate.title}</h2>
                </div>
